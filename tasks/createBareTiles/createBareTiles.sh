...
gsutil -m cp gs://nature-watch-bucket/COGS/bare/2022/bare2022_170000032768-0000000000.tif /container/data/input
...
# Make tiles
echo "6. Make tiles"
gdal2tiles.py -z 0-5 -s EPSG:4326 -r cubic -w none -a 0 --xyz /container/data/masked.vrt /container/data/output

# Copy local tiles to gc
echo "7. Upload to GC"
gsutil -m cp -r /container/data/output/* gs://nature-watch-bucket/tiles/bare/2022
