...
gsutil -m cp gs://nature-watch-bucket/COGS/crop/2019/crop2019_13.tif  /container/data/input
...
# Make tiles
echo "6. Make tiles"
gdal2tiles.py -z 0-6 -s EPSG:4326 -r average -w none -a 0 --xyz /container/data/colored.tif /container/data/output
