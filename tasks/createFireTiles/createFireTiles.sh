...
gsutil -m cp gs://nature-watch-bucket/COGS/fire/2022/fire2022_13.tif  /container/data/input
...
# Make tiles
echo "6. Make tiles"
gdal2tiles.py -z 0-5 -s EPSG:4326 -r cubic -w none -a 0 --xyz /container/data/colored.tif /container/data/output
