...
gsutil -m cp gs://nature-watch-bucket/COGS/fire/2022/*  /container/data/input
...
# Make tiles
echo "6. Make tiles"
gdal2tiles.py -z 0-12 -s EPSG:4326 -r bilinear -w none -a 0 --xyz /container/data/colored.tif /container/data/output
