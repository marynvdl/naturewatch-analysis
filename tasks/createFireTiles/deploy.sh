...
docker build --no-cache -t create-fire-tiles:1.0.6 .
docker run -v ~/key.json:/tmp/keys/key.json -v ~/vm_data:/container/data -d --name create-fire-tiles create-fire-tiles:1.0.6
